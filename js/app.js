  ...
  initEvents() {
    ...
    if (this.btnSaveExp) {
      this.btnSaveExp.addEventListener('click', () => {
        ...
        this.calculateAudit();
        showValetecToast(`Salida de S/ ${val.toFixed(2)} registrada en caja chica.`, "warning");
      });
    }
  ...
  initEvents() {
    ...
    if (this.btnSave) {
      this.btnSave.addEventListener('click', () => {
        ...
        showValetecToast("Mercadería ingresada al Kardex con éxito.", "success");
      });
    }
  }
      ...
      this.btnApprove.addEventListener('click', () => {
        if (this.activeFolio) {
          ...
          if (r) {
            r.status = 'dispensed';
            this.render();
            showValetecToast(`Receta ${r.folio} validada y autorizada para mostrador.`, "success");
          }
        }
        this.toggleModal(false);
      });
